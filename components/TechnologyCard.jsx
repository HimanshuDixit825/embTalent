...
//         if (isSameTechnology) {
//           // Same technology selected - fetch existing skills
//           const token = localStorage.getItem("recruitment_flow_token");
//           if (token) {
//             try {
//               const response = await fetch(
//                 `/api/lead-line-item?token=${token}`
//               );
...
//               if (data.must_have?.length > 0 || data.good_to_have?.length > 0) {
//                 data.must_have?.forEach((skill) =>
//                   dispatch(addMustHaveSkill(skill))
//                 );
//                 data.good_to_have?.forEach((skill) =>
...
//           }
//         } else {
//           // Different technology - create new record
//           const response = await fetch("/api/lead-line-item", {
//             method: "POST",
//             headers: {
//               "Content-Type": "application/json",
