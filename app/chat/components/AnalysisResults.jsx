    ...
    <div className="space-y-8 h-full">
      <div>
        <div className="flex justify-between items-center mb-4">
          ...
          <span
            className={`text-sm ${
              mustHaveSkills.length >= 7 ? "text-amber-400" : "text-gray-400"
            }`}
          >
            {mustHaveSkills.length}/8
          </span>
        </div>
        <div className="bg-[#3C3C3C] bg-opacity-90 backdrop-blur-sm rounded-lg p-2 sm:p-4 flex flex-wrap gap-2 sm:gap-3 relative">
      ...
      <div>
        <div className="flex justify-between items-center mb-4">
          ...
          <span
            className={`text-sm ${
              goodToHaveSkills.length >= 7 ? "text-amber-400" : "text-gray-400"
            }`}
          >
      ...
      {results?.explanation && (
        <div>
          ...
          <div className="bg-[#3C3C3C] bg-opacity-90 backdrop-blur-sm rounded-lg p-2 sm:p-4 overflow-y-auto">
